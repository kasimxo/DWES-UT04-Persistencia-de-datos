...
urlpatterns = [
    ...
    path('login/', LoginView.as_view(template_name='login/login.html', redirect_authenticated_user=True, extra_context={'page_title': 'Iniciar sesión - Tarea Planner'}), name='login'),
